Game Description: 2 player game, each player has a hand of 5 cards and a deck of 54 cards, split into 27 random cards for each player. Each card is given an effect and wins against any card of a lower rank. Players can play any card in their hand each turn. Once a player's deck is fully depleted, that player loses. 
